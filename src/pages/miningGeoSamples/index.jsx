...
export default function Index({ permission }) {
  ...
  const columns = [
    {
      title: t("MiningGeoSamples.tableContent.number"),
    ...
    {
      title: t("MiningGeoSamples.tableContent.test_type"),
      dataIndex: "dynamic_value",
      key: "dynamic_value",
      width: 250,
    },
    {
      title: t("MiningGeoSamples.tableContent.result_date"),
    ...
    {
      title: t("MiningGeoSamples.tableContent.note"),
    ...
    {
      title: t("MiningGeoSamples.tableContent.status"),
  ...
  return (
    <>
      <PageTemplate isDeleted={true}
        title={t("MiningGeoSamples.headerContent.title")}
        columns={columns}
        isRefresh={isRefresh}
        ...
        insertButtonText={t("MiningGeoSamples.headerContent.insertButtonText")}
        API={API.MiningGeoSamples}
