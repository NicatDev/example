  ...
  return (
    <Form form={form} className="w-full" layout="vertical">
      <Row>
        {renderFormItem(
          "doc_number",
          "MiningGeoSamples.tableContent.number",
        ...
        {renderFormItem(
          ...
          "MiningGeoSamples.tableContent.test_type",
          <Select options={dynamicValues} placeholder={t('CommonContent.select')} />
        )}
        {renderFormItem(
          "receipt_result_date",
          "MiningGeoSamples.tableContent.result_date",
          <DatePicker className="w-[100%]" placeholder="dd/mm/yyyy" />
        )}
        {renderFormItem(
          "description",
          "MiningGeoSamples.tableContent.note",
          <Input placeholder={t("CommonContent.insertData")} />
        )}
      </Row>
    </Form>
