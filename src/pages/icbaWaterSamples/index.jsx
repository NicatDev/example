...
export default function Index({ permission }) {
  ...
  const columns = [
    {
      title: t("IcbaWaterSamples.tableContent.number"),
    ...
    {
      title: t("IcbaWaterSamples.tableContent.note"),
    ...
    {
      title: t("IcbaWaterSamples.tableContent.status"),
  ...
  return (
    <>
      <PageTemplate 
        isDeleted={true}
        isUserStatus={true}
        title={t("IcbaWaterSamples.headerContent.title")}
        columns={columns}
        isRefresh={isRefresh}
        ...
        insertButtonText={t("IcbaWaterSamples.headerContent.insertButtonText")}
        API={API.IcbaWaterSamples}
