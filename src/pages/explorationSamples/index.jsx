...
export default function Index({ permission }) {
  ...
  const columns = [
    {
      title: t("ExplorationSamples.tableContent.number"),
    ...
    {
      title: t("ExplorationSamples.tableContent.exploration_type"),
      dataIndex: "dynamic_value",
      key: "dynamic_value",
      width: 250,
    },
    {
      title: t("ExplorationSamples.tableContent.result_date"),
    ...
    {
      title: t("ExplorationSamples.tableContent.note"),
    ...
    {
      title: t("ExplorationSamples.tableContent.status"),
  ...
  return (
    <>
      <PageTemplate isDeleted={true}
        title={t("ExplorationSamples.headerContent.title")}
        columns={columns}
        dataKey={"id_hash"}
        isRefresh={isRefresh}
        ...
        insertButtonText={t(
          "ExplorationSamples.headerContent.insertButtonText"
        )}
        API={API.ExplorationSamples}
