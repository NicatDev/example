  ...
  return (
    <Form form={form} className="w-full" layout="vertical">
      <Row>
        {renderFormItem(
          "doc_number",
          "ExplorationSamples.tableContent.number",
        ...
        {renderFormItem(
          ...
          "ExplorationSamples.tableContent.exploration_type",
          <Select options={dynamicValues} placeholder={t('CommonContent.select')} />
        )}
        {renderFormItem(
          "receipt_result_date",
          "ExplorationSamples.tableContent.result_date",
          <DatePicker className="w-[100%]" placeholder="dd/mm/yyyy" />
        )}
        {renderFormItem(
          "description",
          "ExplorationSamples.tableContent.note",
          <Input placeholder={t("CommonContent.insertData")} />
        )}
      </Row>
    </Form>
